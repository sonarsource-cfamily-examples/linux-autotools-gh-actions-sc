...
// URIs:
:uri-qg-status: https://sonarcloud.io/dashboard?id=sc-sq-c-family-examples_linux-autotools-gh-actions-sc
:img-qg-status: https://sonarcloud.io/api/project_badges/measure?project=sc-sq-c-family-examples_linux-autotools-gh-actions-sc&metric=alert_status
...
*This project is analysed on https://sonarcloud.io/dashboard?id=sc-sq-c-family-examples_linux-autotools-gh-actions-sc[SonarCloud]!*
